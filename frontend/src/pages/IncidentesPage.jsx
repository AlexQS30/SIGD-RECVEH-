...
import PanelDiligencias from "../components/mapa/PanelDiligencias";
    ...
    <div style={s.layout}>
      ...
      <main style={s.main}>
        ...
        <div style={s.filtros}>
          ...
          {/* ← Agrega esto */}
          <BotonesReporte tipoDelito={filtroTipo} />
        </div>
          ...
          <div style={s.modalOverlay}>
            <div style={s.modal}>
              ...
              <form onSubmit={handleSubmit}>
                    ...
                    <div style={s.formGroup}>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setForm({
                            ...form,
                            numDenunciaSirdic: e.target.value,
                          })
                        }
                      />
                    </div>
                ...
                {/* Sección 2: Vehículos */}
                <div style={s.seccion}>
                  <h3 style={s.seccionTitle}>Vehículo(s) Involucrado(s)</h3>
                  ...
                  {form.vehiculoIds.length === 0 && (
                    <p style={s.hint}>
                      🚗 Busca el vehículo por placa para vincularlo al
                      incidente
                    </p>
                  )}
                </div>
                ...
                <div style={s.seccion}>
                  <h3 style={s.seccionTitle}>Ubicación del Hecho *</h3>
                  <SelectorUbicacion
        ...
        {detalle && (
          <div style={s.modalOverlay} onClick={() => setDetalle(null)}>
            ...
            >
              {/* Columna izquierda — datos del incidente */}
              <div
                style={{
                  padding: "28px",
                  overflowY: "auto",
              ...
              >
                ...
                >
                  <h2 style={s.modalTitle}>📋 {detalle.numeroCaso}</h2>
                  <button style={s.btnClose} onClick={() => setDetalle(null)}>
                    ✕
                  </button>
                </div>
                ...
                <div style={s.detalleGrid}>
                  ...
                  {detalle.ubicaciones?.map((u, i) => (
                    <div key={i} style={s.detalleRow}>
                      <span style={s.detalleKey}>{u.tipoUbicacion}</span>
                      <div>
        ...
        <div style={s.tableContainer}>
          {loading ? (
            ...
            <div style={s.empty}>No se encontraron incidentes registrados</div>
          ) : (
            <table style={s.table}>
              <thead>
                <tr style={s.thead}>
              ...
              <tbody>
                {incidentes.map((inc, i) => (
                  <tr key={inc.id} style={i % 2 === 0 ? s.trEven : s.trOdd}>
                    <td style={s.td}>
                      <span style={s.numeroCaso}>{inc.numeroCaso}</span>
                    </td>
                    <td style={s.td}>
                      <span
                        style={{
                    ...
                    <td style={s.td}>{inc.numDenunciaSirdic || "-"}</td>
                    <td style={s.td}>
                      {inc.vehiculos?.map((v) => (
